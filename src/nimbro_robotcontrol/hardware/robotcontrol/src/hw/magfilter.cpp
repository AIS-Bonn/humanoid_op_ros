...
MagFilter::MagFilter(const std::string& paramPath, double cycleTime)
	: m_cycleTime(0.010)
	, m_calibDataDebounce(paramPath + "/calibDataDebounce", 0.0, 0.0005, 0.02, 0.008)
	, m_autoCalibEnable(paramPath + "/autoCalib/enable", false)
	, m_autoCalibClearData(paramPath + "/autoCalib/clearBufData", false)
	, m_autoCalibShowAllData(paramPath + "/autoCalib/showAllData", false)
	, m_autoCalibShowDebug(paramPath + "/autoCalib/showDebugMessages", false)
	, m_autoCalibBufSize(paramPath + "/autoCalib/bufSize", 10, 5, 500, 100)
	, m_autoCalibCountForUpdate(paramPath + "/autoCalib/countForUpdate", 10, 5, 500, 100)
	, m_autoCalibTimeForUpdate(paramPath + "/autoCalib/timeForUpdate", 1.0, 0.5, 60.0, 10.0)
	, m_autoCalibTiltBound(paramPath + "/autoCalib/tiltBound", 0.002, 0.002, 0.2, 0.05)
	, m_autoCalibTiltBoundZ(paramPath + "/autoCalib/tiltBoundZ", 0.005, 0.005, 0.4, 0.2)
	, m_autoCalibUseTiltBoundZ(paramPath + "/autoCalib/useTiltBoundZ", true)
	, m_autoCalibBuf()
	...
	, m_autoCalibMeanDistSmall(paramPath + "/autoCalib/confidences/meanDistSmall", 0.0, 0.01, 1.0, 0.15)
	, m_autoCalibMeanDistLarge(paramPath + "/autoCalib/confidences/meanDistLarge", 0.0, 0.01, 1.0, 0.50)
	, m_autoCalibSpreadAngleMin(paramPath + "/autoCalib/confidences/spreadAngleMin", 0.4, 0.01, 1.0, 0.7)
	, m_autoCalibSpreadAngleTol(paramPath + "/autoCalib/confidences/spreadAngleTol", 0.01, 0.01, 0.4, 0.2)
	, m_autoCalibSpreadErrorMin(paramPath + "/autoCalib/confidences/spreadErrorMin", 0.0, 0.001, 0.1, 0.02)
	, m_autoCalibSpreadErrorMax(paramPath + "/autoCalib/confidences/spreadErrorMax", 0.05, 0.002, 0.25, 0.13)
	, m_autoCalibPlanarSpreadSmall(paramPath + "/autoCalib/confidences/planarSpreadSmall", 0.0, 0.01, 1.0, 0.1)
	, m_autoCalibPlanarSpreadLarge(paramPath + "/autoCalib/confidences/planarSpreadLarge", 0.0, 0.01, 1.0, 0.3)
	, m_autoCalibRadiusErrLimit(paramPath + "/autoCalib/confidences/radiusErrLimit", 0.01, 0.01, 1.0, 0.15)
	, m_autoCalibPreferRadius(paramPath + "/autoCalib/confidences/preferRadius", 0.0, 0.02, 2.0, 0.5)
	, m_autoCalibReqFittedConf(paramPath + "/autoCalib/confidences/requiredFittedConf", 0.1, 0.01, 1.0, 1.0)
	, m_autoCalibResetToHard(paramPath + "/autoCalib/resetToHardIron", false)
	, m_autoCalibEnableXY(paramPath + "/autoCalib/enableFilter/enableFilterXY", false)
	, m_autoCalibEnableZ(paramPath + "/autoCalib/enableFilter/enableFilterZ", false)
	, m_autoCalibEnableR(paramPath + "/autoCalib/enableFilter/enableFilterR", false)
	, m_autoCalibFilterTsXY(paramPath + "/autoCalib/filter/TsXY", 5.0, 0.5, 60.0, 20.0)
	, m_autoCalibFilterTsZ(paramPath + "/autoCalib/filter/TsZ", 10.0, 0.5, 100.0, 50.0)
	, m_autoCalibFilterTsR(paramPath + "/autoCalib/filter/TsR", 10.0, 0.5, 100.0, 50.0)
	, m_autoCalibFilterDeltaXY(paramPath + "/autoCalib/filter/deltaXY", 0.0, 0.0005, 0.05, 0.005)
	, m_autoCalibFilterDeltaZ(paramPath + "/autoCalib/filter/deltaZ", 0.0, 0.0002, 0.02, 0.002)
	, m_autoCalibFilterDeltaR(paramPath + "/autoCalib/filter/deltaR", 0.0, 0.0002, 0.02, 0.002)
	, m_autoCalibTest(false)
	, m_enable_hard(paramPath + "/hard/enableHardIron", false)
	, m_hardSetFromAutoCalib(paramPath + "/hard/setFromAutoCalib", false)
	, m_hard_x(paramPath + "/hard/x", -3.0, 0.01, 3.0, 0.0)
	, m_hard_y(paramPath + "/hard/y", -3.0, 0.01, 3.0, 0.0)
	, m_hard_z(paramPath + "/hard/z", -3.0, 0.01, 3.0, 0.0)
	, m_hard_B(paramPath + "/hard/B", 0.0, 0.02, 3.0, 1.0)
	, m_hard_R(paramPath + "/hard/R", 0.0, 0.02, 3.0, 1.0)
	, m_hard_zR(paramPath + "/hard/zR", -3.0, 0.01, 3.0, 0.0)
	, m_hardOffset(Eigen::Vector3d::Zero())
	, m_hardField(1.0)
	, m_hardRadius(1.0)
	, m_hardOffset2DZ(0.0)
	, m_enable_soft(paramPath + "/soft/enableSoftIron", false)
	, m_soft_hx(paramPath + "/soft/hx", -3.0, 0.01, 3.0, 0.0)
	, m_soft_hy(paramPath + "/soft/hy", -3.0, 0.01, 3.0, 0.0)
	, m_soft_hz(paramPath + "/soft/hz", -3.0, 0.01, 3.0, 0.0)
	, m_soft_w1(paramPath + "/soft/w1", -10.0, 0.05, 10.0, 1.0)
	, m_soft_w2(paramPath + "/soft/w2", -10.0, 0.05, 10.0, 0.0)
	, m_soft_w3(paramPath + "/soft/w3", -10.0, 0.05, 10.0, 0.0)
	, m_soft_w4(paramPath + "/soft/w4", -10.0, 0.05, 10.0, 1.0)
	, m_soft_w5(paramPath + "/soft/w5", -10.0, 0.05, 10.0, 0.0)
	, m_soft_w6(paramPath + "/soft/w6", -10.0, 0.05, 10.0, 1.0)
	, m_soft_B(paramPath + "/soft/B", 0.0, 0.02, 3.0, 1.0)
	...
	, m_calibrating(false)
	, m_showCalib(paramPath + "/showCalib", false)
	, m_showAutoCalib(paramPath + "/showAutoCalib", false)
	, m_clearCalibMarkers(paramPath + "/clearCalibMarkers", false)
	, MM("~mag_calib_data", 2, true, "/ego_rot", paramPath)
	, m_plotData(paramPath + "/plotData", false)
	, PM(PM_COUNT, paramPath)
{
	// Set the cycle time
	...
	m_srv_abortCalibration        = nh.advertiseService(paramPath + "/abortCalibration", &MagFilter::abortCalibration, this);
	m_srv_showCalibration         = nh.advertiseService(paramPath + "/showCalibration", &MagFilter::showCalibration, this);
	m_srv_clearCalibrationMarkers = nh.advertiseService(paramPath + "/clearCalibrationMarkers", &MagFilter::clearCalibrationMarkers, this);
	...
	m_srv_testAutoCalib           = nh.advertiseService(paramPath + "/testAutoCalib", &MagFilter::handleTestAutoCalib, this);
...
// Constructor
MagFilter::MarkerMan::MarkerMan(const std::string& topicName, int publishInterval, bool enabled, const std::string& refFrame, const std::string& paramPath)
 : MarkerManager(topicName, publishInterval, enabled)
 , visible(false)
 , hideAuto(true)
 , RawData(this, refFrame, paramPath + "/raw")
 , AutoData(this, refFrame, paramPath + "/auto")
 , FixedData(this, refFrame, paramPath + "/fixed")
 , HardCircle(this, refFrame, paramPath + "/hard")
 , HardCircleC(this, refFrame, MM_CENTRE_SIZE, paramPath + "/hard")
 , HardSphere(this, refFrame, 1.0, paramPath + "/hard")
 , HardSphereC(this, refFrame, MM_CENTRE_SIZE, paramPath + "/hard")
 , HardPlaneNormal(this, refFrame, MM_ARROW_SHAFT_DIAM, MM_ARROW_HEAD_DIAM, MM_ARROW_HEAD_LEN, paramPath + "/hard")
 , SoftEllipse(this, refFrame, paramPath + "/soft")
 , SoftEllipseC(this, refFrame, MM_CENTRE_SIZE, paramPath + "/soft")
 , SoftEllipsoid(this, refFrame, 1.0, paramPath + "/soft")
 , SoftEllipsoidC(this, refFrame, MM_CENTRE_SIZE, paramPath + "/soft")
 , SoftFixedSphere(this, refFrame, 1.0, paramPath + "/softFixed")
 , SoftFixedSphereC(this, refFrame, MM_CENTRE_SIZE, paramPath + "/softFixed")
 , AutoDataVar(this, refFrame, paramPath + "/autoDebug")
 , AutoDataMean(this, refFrame, MM_CENTRE_SIZE, paramPath + "/autoDebug")
 , AutoDataText(this, refFrame, MM_TEXT_SIZE, paramPath + "/autoDebug")
 , AutoMeanCircle(this, refFrame, paramPath + "/autoDebug")
 , AutoMeanCircleC(this, refFrame, MM_CENTRE_SIZE, paramPath + "/autoDebug")
 , AutoMeanText(this, refFrame, MM_TEXT_SIZE, paramPath + "/autoDebug")
 , AutoFittedCircle(this, refFrame, paramPath + "/autoDebug")
 , AutoFittedCircleC(this, refFrame, MM_CENTRE_SIZE, paramPath + "/autoDebug")
 , AutoFittedText(this, refFrame, MM_TEXT_SIZE, paramPath + "/autoDebug")
 , AutoTargetCircle(this, refFrame, paramPath + "/auto")
 , AutoTargetCircleC(this, refFrame, MM_CENTRE_SIZE, paramPath + "/auto")
 , AutoTargetText(this, refFrame, MM_TEXT_SIZE, paramPath + "/auto")
 , AutoCurCircle(this, refFrame, paramPath + "/auto")
 , AutoCurCircleC(this, refFrame, MM_CENTRE_SIZE, paramPath + "/auto")
 , AutoCurText(this, refFrame, MM_TEXT_SIZE, paramPath + "/auto")
{
