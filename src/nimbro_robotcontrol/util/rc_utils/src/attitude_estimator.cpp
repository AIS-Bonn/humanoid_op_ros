...
void AttitudeEstimator::getAttitude(double q[], const double qOffset[]) const
{
	// Calculate the attitude estimate biased by the conjugate of the quaternion offset
	q[0] = m_Qhat[0]*qOffset[0] + m_Qhat[1]*qOffset[1] + m_Qhat[2]*qOffset[2] + m_Qhat[3]*qOffset[3];
	q[1] = m_Qhat[1]*qOffset[0] - m_Qhat[0]*qOffset[1] + m_Qhat[3]*qOffset[2] - m_Qhat[2]*qOffset[3];
	q[2] = m_Qhat[2]*qOffset[0] - m_Qhat[3]*qOffset[1] - m_Qhat[0]*qOffset[2] + m_Qhat[1]*qOffset[3];
	q[3] = m_Qhat[3]*qOffset[0] + m_Qhat[2]*qOffset[1] - m_Qhat[1]*qOffset[2] - m_Qhat[0]*qOffset[3];
	
	// Normalise the quaternion output
	double qscale = q[0]*q[0] + q[1]*q[1] + q[2]*q[2] + q[3]*q[3];
...
void AttitudeEstimator::getPIGains(double &Kp, double &Ti, double &KpQuick, double &TiQuick) const
{
