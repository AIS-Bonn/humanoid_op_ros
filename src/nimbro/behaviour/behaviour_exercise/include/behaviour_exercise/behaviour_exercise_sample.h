// behaviour_exercise_sample.h - Philipp Allgeuer - 12/07/13
// Sample header file for behaviours exercise

// Ensure header is only included once
#ifndef BEHAVIOUR_EXERCISE_SAMPLE_H
#define BEHAVIOUR_EXERCISE_SAMPLE_H
...
namespace behaviourexercise
{
	...
	class SearchForBallState : public GenState<RobotSC>
	{
	public:
		// Constructor
		SearchForBallState(RobotSC* sc) : GenState(sc, SEARCH_FOR_BALL, "SEARCH_FOR_BALL") {}
	...
	class ApproachBallState : public GenState<RobotSC>
	{
	public:
		// Constructor
		ApproachBallState(RobotSC* sc) : GenState(sc, APPROACH_BALL, "APPROACH_BALL") {}
	...
	protected:
		...
		double adjustCmdForObstacle(gait_msgs::GaitCommand& cmd, Eigen::Vector2d ballVec, Eigen::Vector2d obstVec);
	};

	// KickBallState class
	class KickBallState : public GenState<RobotSC>
	{
	public:
		// Constructor
		KickBallState(RobotSC* sc) : GenState(sc, KICK_BALL, "KICK_BALL") {}
...
#endif /* BEHAVIOUR_EXERCISE_SAMPLE_H */
// EOF