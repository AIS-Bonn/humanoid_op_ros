...
#ifndef SITTING_DEMO_H
#define SITTING_DEMO_H
...
namespace sitting_demo
{
	...
	public:
		...
		inline bool enabled() const { return m_enabled && m_sittingDemoEnabled(); }
		inline bool robotIsSitting() const { return m_robotIsSitting; }
	...
	private:
		...
		config_server::Parameter<bool> m_sittingDemoEnabled;
